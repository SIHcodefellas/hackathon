                ...
                <View style={styles.commonsection1and2}>
                    ...
                    <View style={styles.section1}>
                        ...
                        <View style={styles.lawyerdetails}>
                            ...
                            <Text style={styles.lawyernumber}>
                                +91 9034567890
                            </Text>
                            <Text style={styles.lawyerspec}>
                                {" "}
                                Criminal Defense
                            </Text>
                ...
                <View style={styles.section3}>
                    ...
                    <View style={styles.profileCardContainer}>
                        ...
                        <View style={styles.profileCard}>
                            ...
                            <Text style={styles.prisonercourt}>
                                Next Court:
                            </Text>
                            <Text style={styles.prisonercourtdate}>
                                12th Sept
                            </Text>
                        </View>
...
const styles = StyleSheet.create({
    ...
    nav: {
        ...
        position: "absolute", // Keep the navigation bar fixed in its position
