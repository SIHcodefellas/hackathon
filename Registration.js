  ...
  return (
    ...
    >
      ...
      <View style={styles.genderContainer}>
        ...
        />
        <Text style={styles.subSubHeading}>Create Username and Password:</Text>
        <TextInput
          style={styles.input}
        ...
        <View style={styles.buttonContainer}>
            <View style={styles.registerButton}>
                <Button
                title="Register"
                onPress={() => {/* Add your registration logic */}}
            ...
            <View style={styles.loginButton}>
                <Button
                title="Login"
                onPress={() => {/* Add your login logic */}}
                color="#916863" // Background color
                // titleStyle={{ color: "#916863" }} // Text color
                />
            </View>
        </View>
